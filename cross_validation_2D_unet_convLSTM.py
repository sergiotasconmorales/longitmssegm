...
if(debug):
    experiment_name = "dummy_experiment_CROSS_VALIDATION_UNet_ConvLSTM"
else: 
    experiment_name, curr_date, curr_time = get_experiment_name(the_prefix = "CROSS_VALIDATION_unet2dconvLSTM")
