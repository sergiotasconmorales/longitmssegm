...
import numpy as np  
import pandas as pd
from ms_segmentation.general.general import create_folder, list_folders, get_experiment_name, create_log, cls
from os.path import join as jp
from ms_segmentation.plot.plot import shim_slice, shim_overlay_slice, shim, shim_overlay, plot_learning_curve
from medpy.io import load
from ms_segmentation.data_generation.slice_manager import SlicesLoader
...
from ms_segmentation.architectures.unet3d import Unet3D, Unet_orig, UNet3D_1, UNet3D_2
from ms_segmentation.architectures.c_gru import ConvGRU
...
experiment_name, curr_date, curr_time = get_experiment_name(the_prefix = "ConvGRU")
#experiment_name = 'unet3d_2020-03-21_12_43_54'
...
# Patch sampling type
options['patch_sampling'] = 'balanced' # (mask, balanced or balanced+roi or non-uniform)
# Loss
...
lesion_model = ConvGRU(input_size=(100,100),
                        input_dim = 32,
                        hidden_dim = [32],
                        kernel_size = (3,3),
                        num_layers = 1,
...
lesion_model.cuda()
input_tensor = torch.rand(1, 4, 32, 100,100).cuda()
layer_output_list, last_state_list = lesion_model(input_tensor)
