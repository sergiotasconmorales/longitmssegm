...
class ConvGRU(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
        ...
        self.pad = kernel_size[0][0] // 2, kernel_size[1][0] // 2

        self.last_layer = nn.Conv3d(in_channels=hidden_dim[-1],
                                    out_channels=2,  # for update_gate,reset_gate respectively
                                    kernel_size=1)
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        #output = F.softmax(self.last_layer(layer_output_list[-1].permute(0,2,1,3,4)), dim=1)
